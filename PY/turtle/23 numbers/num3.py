...
# https://stepik.org/lesson/1747822/step/3 5.23 Задания черепашка Цифры
# Решение Задание: Нарисовать цифру «3» почтовым стилем

#/CodeVMeshke/PY/turtle/23 numbers/num3.py
t.penup()
