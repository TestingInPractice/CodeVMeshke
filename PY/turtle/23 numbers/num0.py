...
# https://stepik.org/lesson/1747822/step/10 5.23 Задания черепашка Цифры
# Решение Задание: Нарисовать цифру «0» почтовым стилем

#/CodeVMeshke/PY/turtle/23 numbers/num0.py
t.penup()
