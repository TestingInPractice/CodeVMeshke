...
#https://stepik.org/lesson/1768655/step/2 5.41 def 3 Задания
# Нарисовать Напишите пример простого фреймворка на Python с использованием модуля turtle, который содержит процедуры для рисования треугольника, квадрата, круга, буквы Х. В качестве параметра каждой процедуры задаются координаты начала рисования (левый нижний угол для треугольника и квадрата, центр для круга, центр буквы):
# /CodeVMeshke/PY/turtle/41 def 3/def_3_2.py
