...
#https://stepik.org/lesson/1744606/step/8  5.33 Цикл 2 Задания
# Решение Напишите программу на Python с использованием модуля turtle, которая рисует 5 концентрических квадратов («матрёшкой») с заливкой пространства между ними разными цветами.
#/CodeVMeshke/PY/turtle/33 circle 2/circle2_8.py
