...
#https://stepik.org/lesson/1744606/step/13  5.33 Цикл 2 Задания
# Решение Задание: Нарисовать доску 4×4 из квадратов, повернутых на 45 градусов, при этом ряды остаются горизонтальными
#/CodeVMeshke/PY/turtle/33 circle 2/circle2_13.py
