...
#https://stepik.org/lesson/1747795/step/2  5.32 Списки и словари
# Решение Нарисовать из центра 5 кругов разного размера и цвета в цикле, используя список цветов
# colors = ['', 'purple', 'orange', 'cyan', 'magenta', 'lime']
# На каждом шаге цикла менять цвет круга и увеличивать радиус.
#/CodeVMeshke/PY/turtle/32 list/list_1.py
