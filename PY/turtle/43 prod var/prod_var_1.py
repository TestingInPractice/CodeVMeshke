...
#https://stepik.org/lesson/1769319/step/1 5.42 Продвинутое использование переменных 1
...
# На каждом шаге цикла рисовать круг с радиусом, увеличивающимся на 1 пиксель.
# /CodeVMeshke/PY/turtle/43 prod var/prod_var_1.py
...
def draw_tunnel_circles(x, y, start_radius, count):
    ...
    Каждый следующий круг рисуется с радиусом на 1 больше предыдущего.
    """
    radius = start_radius
